...
public class SwerveDef {
    ...
    public static SteerMotor flSteer = new SteerMotor(0, FL_STEER_INVERT_TYPE);
    public static DriveMotor flDrive = new DriveMotor(1, FL_DRIVE_INVERT_TYPE);
    public static SwerveModule flModule = new SwerveModule(flSteer, FL_STEER_PID_VALUES, flDrive, FL_DRIVE_PID_VALUES, FL_STEER_OFFSET);

    public static SteerMotor frSteer = new SteerMotor(2, FR_STEER_INVERT_TYPE);
    public static DriveMotor frDrive= new DriveMotor(3, FR_DRIVE_INVERT_TYPE);
    public static SwerveModule frModule = new SwerveModule(frSteer, FR_STEER_PID_VALUES, frDrive, FR_DRIVE_PID_VALUES, FR_STEER_OFFSET);

    public static SteerMotor rlSteer = new SteerMotor(4, RL_STEER_INVERT_TYPE);
    public static DriveMotor rlDrive = new DriveMotor(5, RL_DRIVE_INVERT_TYPE);
    public static SwerveModule rlModule = new SwerveModule(rlSteer, RL_STEER_PID_VALUES, rlDrive, RL_DRIVE_PID_VALUES, RL_STEER_OFFSET);

    public static SteerMotor rrSteer = new SteerMotor(6, RR_STEER_INVERT_TYPE);
    public static DriveMotor rrDrive = new DriveMotor(7, RR_DRIVE_INVERT_TYPE);
    public static SwerveModule rrModule = new SwerveModule(rrSteer, RR_STEER_PID_VALUES, rrDrive, RR_DRIVE_PID_VALUES, RR_STEER_OFFSET);
    ...
    //Use this structure when using off-motor encoder. Implement in SwerveModule class!
    ...
    public static class SwerveModule {
        ...
        public void zeroSwerve() {
            steerMotor.setSelectedSensorPosition(steerMotor.getSelectedSensorPosition(), 0, TIMEOUT_MS);
        }

        public SwerveModuleState getState() {
            return new SwerveModuleState(driveMotor.getSelectedSensorVelocity(0)*DRIVE_DIST_PER_WHEEL_REV/(0.1*DRIVE_TICKS_PER_MOTOR_REV), new Rotation2d(Math.toRadians(steerMotor.getSelectedSensorPosition())));
        }
        ...
        public void setState(SwerveModuleState stateToSet) {
            ...
            //double speed = optimizedState.speedMetersPerSecond*(0.1*DRIVE_TICKS_PER_MOTOR_REV/(DRIVE_DIST_PER_WHEEL_REV)); probably not needed
